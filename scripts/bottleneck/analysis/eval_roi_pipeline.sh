...
python scripts/bottleneck/analysis/roi_vdvae_reconstruct.py -cap long && \
...
python scripts/bottleneck/analysis/roi_vdvae_reconstruct.py -cap short && \
...
python scripts/bottleneck/analysis/roi_vdvae_reconstruct.py -cap preliminary && \
